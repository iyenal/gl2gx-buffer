# 1 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/libutil/error.c"
# 1 "D:\\devkitPro\\portlibs\\thirdparty\\gl2gx\\libogc\\wii_release//"
# 1 "<command-line>"
# 1 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/libutil/error.c"
# 38 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/libutil/error.c"
# 1 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/include/gluos.h" 1
# 39 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/libutil/error.c" 2
# 1 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/libutil/gluint.h" 1
# 41 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/libutil/gluint.h"
extern const char *__gluNURBSErrorString( int errno );

extern const char *__gluTessErrorString( int errno );
# 40 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/libutil/error.c" 2
# 1 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/include/GL/glu.h" 1
# 37 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/include/GL/glu.h"
...
# 38 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/include/GL/glu.h" 2
...
# 41 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/libutil/error.c" 2
...
# 47 "d:\\devkitpro\\devkitppc\\powerpc-eabi\\include\\stdio.h" 3
...
# 42 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/libutil/error.c" 2


static const char *glErrorStrings[0x0505 - 0x0500 + 1] = {
    "invalid enumerant",
    "invalid value",
    "invalid operation",
    "stack overflow",
...
static const char *gluErrorStrings[100904 - 100900 + 1] = {
    "invalid enumerant",
    "invalid value",
    "out of memory",
    "",
...
extern const char *glErrFile;
extern int glErrLine;
static char error_string[1024] = {0};

const GLubyte* __attribute__((visibility("default")))
gluErrorString(GLenum errorCode)
{
    if (errorCode == 0) {
 return (const unsigned char *) "no error";
    }
    if ((errorCode >= 0x0500) && (errorCode <= 0x0505)) {
  snprintf(error_string, sizeof(error_string), "%s at %s - %d", glErrorStrings[errorCode - 0x0500], glErrFile, glErrLine);
  return (const unsigned char *)error_string;
    }
    if (errorCode == 0x8031) {
        return (const unsigned char *) "table too large";
    }
    if ((errorCode >= 100900) && (errorCode <= 100904)) {
 return (const unsigned char *) gluErrorStrings[errorCode - 100900];
    }
    if ((errorCode >= 100251) && (errorCode <= 100287)) {
 return (const unsigned char *) __gluNURBSErrorString(errorCode - (100251 - 1));
    }
    if ((errorCode >= 100151) && (errorCode <= 100158)) {
 return (const unsigned char *) __gluTessErrorString(errorCode - (100151 - 1));
    }
