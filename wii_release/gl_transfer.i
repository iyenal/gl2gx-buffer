# 1 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/gl_transfer.c"
...
# 2 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/gl_transfer.c" 2
...
# 3 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/gl_transfer.c" 2
...
# 4 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/gl_transfer.c" 2
...
# 5 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/gl_transfer.c" 2
...
# 7 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/gl_transfer.c" 2
...
# 10 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/gl_transfer.c" 2
...
# 12 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/gl_transfer.c" 2
...
void glPixelTransferf(GLenum pname, GLfloat param)
{
 switch(pname)
 {
    case 0x0D14: Trans[TRAN_R].scale = param; break;
    case 0x0D15: Trans[TRAN_R].scale = param; break;
    case 0x0D18: Trans[TRAN_G].scale = param; break;
    case 0x0D19: Trans[TRAN_G].scale = param; break;
    case 0x0D1A: Trans[TRAN_B].scale = param; break;
    case 0x0D1B: Trans[TRAN_B].scale = param; break;
    case 0x0D1C: Trans[TRAN_A].scale = param; break;
    case 0x0D1D: Trans[TRAN_A].bias = param; break;
 case 0x0D10:
 case 0x0D11:
 case 0x0D12:
 case 0x0D13:
    ...
    case 0x0D1F:
 default:
  _glSetErrorEx(0x0500, "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/gl_transfer.c", 74);
  return;
 }
}
...
void _glGetPixelTransferf(GLenum pname, GLfloat *param)
{
 if(!param)
 {
  _glSetErrorEx(0x0501, "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/gl_transfer.c", 83);
 }


 switch(pname)
 {
    case 0x0D14: *param = Trans[TRAN_R].scale; break;
    case 0x0D15: *param = Trans[TRAN_R].scale; break;
    case 0x0D18: *param = Trans[TRAN_G].scale; break;
    case 0x0D19: *param = Trans[TRAN_G].scale; break;
    case 0x0D1A: *param = Trans[TRAN_B].scale; break;
    case 0x0D1B: *param = Trans[TRAN_B].scale; break;
    case 0x0D1C: *param = Trans[TRAN_A].scale ; break;
    case 0x0D1D: *param = Trans[TRAN_A].bias; break;
    case 0x0D1E: *param = 1; break;
 case 0x0D10:
 case 0x0D11:
 case 0x0D12:
 case 0x0D13:
    case 0x0D1F: *param = 0; break;
 default:
  _glSetErrorEx(0x0500, "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/gl_transfer.c", 104);
  return;
 }
...
void PlaceII(GLubyte i1, GLubyte i2, void **dest, u32 format)
{
 switch(format)
 {
 case 0x0: Put44(dest, i1, i2); break;
 case 0x1: Put8(dest, i1); Put8(dest, i1); break;
 }
}
...
void PlaceIA(GLubyte i, GLubyte a, void **dest, u32 format)
{
 switch(format)
 {
 case (0x7|0x20): Put8(dest, a); break;
 case 0x1: Put8(dest, i); break;
 case 0x2: Put44(dest, i, a); break;
 case 0x3: Put8(dest, i); Put8(dest, a); break;
 }
}
...
static __inline__ void PlaceC(GLubyte r, GLubyte g, GLubyte b, GLubyte a, void **dest, u32 format, u32 pass)
{
 ...
 case (0x7|0x20):
 case 0x2:
 case 0x3: PlaceIA(GetIlum(r,g,b), a, dest, format); break;
 case 0x5: Put5A3(dest, r, g, b, a); break;
 case 0x4: Put565(dest, r, g, b); break;
 case 0x6:
 {
  if(pass == 0)
  {
...
const GLvoid * pixel_offset(GLenum glFormat, const GLvoid * pixels, GLenum type, size_t width, size_t height, size_t col, size_t row, pixelStore *store)
{
 ...
 case 0x1905:
 case 0x1906:
 case 0x1909: components = 1; break;
 case 0x190A: components = 2; break;
 case 0x80E0:
 case 0x1907: components = 3; break;
 case 0x80E1:
 case 0x1908: components = 4; break;
 }
...
# 658 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/gl_transfer.c"
static __inline__ void getUBYTE_3_3_2(const GLvoid *pixels, GLubyte*c)
{
 u8 val = *((u8*)pixels);

 c[0] = ((val & 0x70) >> 5) * 36.428571428571428571428571428571f;
 c[1] = ((val & 0x1C) >> 2) * 36.428571428571428571428571428571f;
 c[2] = ((val & 0x3)) * 85;
 c[3] = 255;
}
static __inline__ void getUBYTE_2_3_3_REV(const GLvoid *pixels, GLubyte*c)
{
 ...
 c[2] = ((val & 0xC0) >> 6) * 85;
 c[1] = ((val & 0x38) >> 3) * 36.428571428571428571428571428571f;
 c[0] = ((val & 0x7)) * 36.428571428571428571428571428571f;
 c[3] = 255;
}
static __inline__ void getUSHORT_5_6_5(const GLvoid *pixels, GLubyte*c)
{
 ...
 c[0] = ((val & 0xF800) >> 11) * 8.2258064516129032258064516129032f;
 c[1] = ((val & 0x07E0) >> 5) * 4.047619047619047619047619047619f;
 c[2] = ((val & 0x001F)) * 8.2258064516129032258064516129032f;
 c[3] = 255;
}
static __inline__ void getUSHORT_5_6_5_REV(const GLvoid *pixels, GLubyte*c)
{
 ...
 c[2] = ((val & 0xF800) >> 11) * 8.2258064516129032258064516129032f;
 c[1] = ((val & 0x07E0) >> 5) * 4.047619047619047619047619047619f;
 c[0] = ((val & 0x001F)) * 8.2258064516129032258064516129032f;
 c[3] = 255;
};
...
static __inline__ void getUSHORT_5_5_5_1(const GLvoid *pixels, GLubyte*c)
{
 ...
 c[0] = ((val & 0xF800) >> 11) * 8.2258064516129032258064516129032f;
 c[1] = ((val & 0x07C0) >> 6) * 8.2258064516129032258064516129032f;
 c[2] = ((val & 0x003E) >> 1) * 8.2258064516129032258064516129032f;
 c[3] = ((val & 0x0001) >> 0) * 255;
};
static __inline__ void getUSHORT_1_5_5_5_REV(const GLvoid *pixels, GLubyte*c)
{
 u16 val = *((u16*)pixels);

 c[3] = ((val & 0x8000) >> 15) * 255;
 c[2] = ((val & 0x7C00) >> 10) * 8.2258064516129032258064516129032f;
 c[1] = ((val & 0x03E0) >> 5) * 8.2258064516129032258064516129032f;
 c[0] = ((val & 0x001F) >> 0) * 8.2258064516129032258064516129032f;
};
static __inline__ void getUINT_8_8_8_8(const GLvoid *pixels, GLubyte*c)
{
 u32 val = *((u32*)pixels);

 c[0] = ((val & 0xFF000000) >> 24);
 c[1] = ((val & 0x00FF0000) >> 16);
 c[2] = ((val & 0x0000FF00) >> 8);
 c[3] = ((val & 0x000000FF) >> 0);
};
static __inline__ void getUINT_8_8_8_8_REV(const GLvoid *pixels, GLubyte*c)
{
 ...
 c[2] = ((val & 0x00FF0000) >> 16);
 c[1] = ((val & 0x0000FF00) >> 8);
 c[0] = ((val & 0x000000FF) >> 0);
};
static __inline__ void getUINT_10_10_10_2(const GLvoid *pixels, GLubyte*c)
{
 u32 val = *((u32*)pixels);

 c[0] = ((val & 0xFFC00000) >> 22) >> 2;
 c[1] = ((val & 0x003FF000) >> 12) >> 2;
 c[2] = ((val & 0x00000FFC) >> 2) >> 2;
 c[3] = ((val & 0x00000003) >> 0) * 85;
};
static __inline__ void getUINT_2_10_10_10_REV(const GLvoid *pixels, GLubyte*c)
{
 u32 val = *((u32*)pixels);

 c[3] = ((val & 0xC0000000) >> 30) * 85;
 c[2] = ((val & 0x3FF00000) >> 20) >> 2;
 c[1] = ((val & 0x000FFC00) >> 10) >> 2;
 c[0] = ((val & 0x000003FF) >> 0) >> 2;
}
...
{
 Put44(dest, GetIlum(c[0],c[1],c[2]), c[3]);
}
...
{
 Put5A3(dest, c[0], c[1], c[2], c[3]);
}
static __inline__ void put565(GLubyte *c, void **dest)
{
 Put565(dest, c[0], c[1], c[2]);
}
 ...
 const GLvoid *src, GLenum glFormat, GLenum glType, size_t xoffset, size_t yoffset, size_t transwidth, size_t transheight)
{
 ...
 case 0x1:
 case (0x7|0x20):
 case 0x2: dest_size = 1; break;
 case 0x3:
 case 0x5:
 case 0x4: dest_size = 2; break;
 case 0x6: dest_size = 4; break;
 }
 ...
 u8 t;
# 1319 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/gl_transfer.c"
 if(format == 0x5 && glType == 0x8034)
 {
  if(!swap_br)
  {
   for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } move5551(&dest, ((void*)(p + col_size*(x) + row_size*(y)))); } } } };
  }
  else
  {
   for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } move5551br(&dest, ((void*)(p + col_size*(x) + row_size*(y)))); } } } };
  }
  return;
 }

 if(format == 0x5 && glType == 0x8366)
 {
  if(!swap_br)
  {
   for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } move_and_swap5551(&dest, ((void*)(p + col_size*(x) + row_size*(y)))); } } } };
  }
  else
  {
   for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } move_and_swap5551br(&dest, ((void*)(p + col_size*(x) + row_size*(y)))); } } } };
  }
  return;
 }

 if(format == 0x4 && glType == 0x8363)
 {
  if(!swap_br)
  {
   for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } move16(&dest, ((void*)(p + col_size*(x) + row_size*(y)))); } } } };
  }
  else
  {
   for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } move_and_swap565(&dest, ((void*)(p + col_size*(x) + row_size*(y)))); } } } };
  }
  return;
 }

 if(format == 0x4 && glType == 0x8364)
 {
  if(!swap_br)
  {
   for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } move_and_swap565(&dest, ((void*)(p + col_size*(x) + row_size*(y)))); } } } };
 ...
 switch(glType)
 {
 case 0x8032: switch(format) { case 0x1: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUBYTE_3_3_2(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putI8(c, &dest); } } } }; break; case (0x7|0x20): for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUBYTE_3_3_2(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putA8(c, &dest); } } } }; break; case 0x2: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUBYTE_3_3_2(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA4(c, &dest); } } } }; break; case 0x3: switch(glFormat) { case 0x1906: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUBYTE_3_3_2(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA8A(c, &dest); } } } }; break; default: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUBYTE_3_3_2(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA8(c, &dest); } } } }; break; } break; case 0x5: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUBYTE_3_3_2(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; put5A3(c, &dest); } } } }; break; case 0x4: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUBYTE_3_3_2(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; put565(c, &dest); } } } }; break; case 0x6: { for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUBYTE_3_3_2(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putAR(c, &dest); } } for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUBYTE_3_3_2(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putGB(c, &dest); } } } } } break; default: ((void)0); }; break;
    case 0x8362:
  switch(format) { case 0x1: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUBYTE_2_3_3_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putI8(c, &dest); } } } }; break; case (0x7|0x20): for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUBYTE_2_3_3_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putA8(c, &dest); } } } }; break; case 0x2: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUBYTE_2_3_3_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA4(c, &dest); } } } }; break; case 0x3: switch(glFormat) { case 0x1906: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUBYTE_2_3_3_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA8A(c, &dest); } } } }; break; default: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUBYTE_2_3_3_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA8(c, &dest); } } } }; break; } break; case 0x5: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUBYTE_2_3_3_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; put5A3(c, &dest); } } } }; break; case 0x4: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUBYTE_2_3_3_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; put565(c, &dest); } } } }; break; case 0x6: { for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUBYTE_2_3_3_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putAR(c, &dest); } } for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUBYTE_2_3_3_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putGB(c, &dest); } } } } } break; default: ((void)0); }; break;
 case 0x8363:
  switch(format) { case 0x1: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_5_6_5(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putI8(c, &dest); } } } }; break; case (0x7|0x20): for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_5_6_5(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putA8(c, &dest); } } } }; break; case 0x2: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_5_6_5(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA4(c, &dest); } } } }; break; case 0x3: switch(glFormat) { case 0x1906: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_5_6_5(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA8A(c, &dest); } } } }; break; default: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_5_6_5(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA8(c, &dest); } } } }; break; } break; case 0x5: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_5_6_5(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; put5A3(c, &dest); } } } }; break; case 0x4: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_5_6_5(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; put565(c, &dest); } } } }; break; case 0x6: { for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_5_6_5(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putAR(c, &dest); } } for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_5_6_5(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putGB(c, &dest); } } } } } break; default: ((void)0); }; break;
 case 0x8364:
  switch(format) { case 0x1: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_5_6_5_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putI8(c, &dest); } } } }; break; case (0x7|0x20): for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_5_6_5_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putA8(c, &dest); } } } }; break; case 0x2: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_5_6_5_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA4(c, &dest); } } } }; break; case 0x3: switch(glFormat) { case 0x1906: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_5_6_5_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA8A(c, &dest); } } } }; break; default: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_5_6_5_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA8(c, &dest); } } } }; break; } break; case 0x5: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_5_6_5_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; put5A3(c, &dest); } } } }; break; case 0x4: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_5_6_5_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; put565(c, &dest); } } } }; break; case 0x6: { for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_5_6_5_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putAR(c, &dest); } } for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_5_6_5_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putGB(c, &dest); } } } } } break; default: ((void)0); }; break;
 case 0x8033:
  switch(format) { case 0x1: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_4_4_4_4(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putI8(c, &dest); } } } }; break; case (0x7|0x20): for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_4_4_4_4(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putA8(c, &dest); } } } }; break; case 0x2: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_4_4_4_4(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA4(c, &dest); } } } }; break; case 0x3: switch(glFormat) { case 0x1906: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_4_4_4_4(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA8A(c, &dest); } } } }; break; default: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_4_4_4_4(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA8(c, &dest); } } } }; break; } break; case 0x5: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_4_4_4_4(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; put5A3(c, &dest); } } } }; break; case 0x4: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_4_4_4_4(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; put565(c, &dest); } } } }; break; case 0x6: { for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_4_4_4_4(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putAR(c, &dest); } } for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_4_4_4_4(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putGB(c, &dest); } } } } } break; default: ((void)0); }; break;
 case 0x8365:
  switch(format) { case 0x1: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_4_4_4_4_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putI8(c, &dest); } } } }; break; case (0x7|0x20): for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_4_4_4_4_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putA8(c, &dest); } } } }; break; case 0x2: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_4_4_4_4_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA4(c, &dest); } } } }; break; case 0x3: switch(glFormat) { case 0x1906: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_4_4_4_4_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA8A(c, &dest); } } } }; break; default: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_4_4_4_4_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA8(c, &dest); } } } }; break; } break; case 0x5: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_4_4_4_4_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; put5A3(c, &dest); } } } }; break; case 0x4: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_4_4_4_4_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; put565(c, &dest); } } } }; break; case 0x6: { for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_4_4_4_4_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putAR(c, &dest); } } for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_4_4_4_4_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putGB(c, &dest); } } } } } break; default: ((void)0); }; break;
 case 0x8034:
  switch(format) { case 0x1: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_5_5_5_1(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putI8(c, &dest); } } } }; break; case (0x7|0x20): for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_5_5_5_1(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putA8(c, &dest); } } } }; break; case 0x2: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_5_5_5_1(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA4(c, &dest); } } } }; break; case 0x3: switch(glFormat) { case 0x1906: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_5_5_5_1(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA8A(c, &dest); } } } }; break; default: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_5_5_5_1(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA8(c, &dest); } } } }; break; } break; case 0x5: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_5_5_5_1(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; put5A3(c, &dest); } } } }; break; case 0x4: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_5_5_5_1(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; put565(c, &dest); } } } }; break; case 0x6: { for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_5_5_5_1(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putAR(c, &dest); } } for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_5_5_5_1(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putGB(c, &dest); } } } } } break; default: ((void)0); }; break;
    case 0x8366:
  switch(format) { case 0x1: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_1_5_5_5_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putI8(c, &dest); } } } }; break; case (0x7|0x20): for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_1_5_5_5_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putA8(c, &dest); } } } }; break; case 0x2: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_1_5_5_5_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA4(c, &dest); } } } }; break; case 0x3: switch(glFormat) { case 0x1906: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_1_5_5_5_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA8A(c, &dest); } } } }; break; default: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_1_5_5_5_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA8(c, &dest); } } } }; break; } break; case 0x5: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_1_5_5_5_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; put5A3(c, &dest); } } } }; break; case 0x4: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_1_5_5_5_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; put565(c, &dest); } } } }; break; case 0x6: { for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_1_5_5_5_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putAR(c, &dest); } } for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUSHORT_1_5_5_5_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putGB(c, &dest); } } } } } break; default: ((void)0); }; break;
 case 0x8035:
  switch(format) { case 0x1: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUINT_8_8_8_8(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putI8(c, &dest); } } } }; break; case (0x7|0x20): for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUINT_8_8_8_8(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putA8(c, &dest); } } } }; break; case 0x2: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUINT_8_8_8_8(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA4(c, &dest); } } } }; break; case 0x3: switch(glFormat) { case 0x1906: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUINT_8_8_8_8(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA8A(c, &dest); } } } }; break; default: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUINT_8_8_8_8(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA8(c, &dest); } } } }; break; } break; case 0x5: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUINT_8_8_8_8(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; put5A3(c, &dest); } } } }; break; case 0x4: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUINT_8_8_8_8(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; put565(c, &dest); } } } }; break; case 0x6: { for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUINT_8_8_8_8(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putAR(c, &dest); } } for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUINT_8_8_8_8(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putGB(c, &dest); } } } } } break; default: ((void)0); }; break;
 case 0x8367:
  switch(format) { case 0x1: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUINT_8_8_8_8_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putI8(c, &dest); } } } }; break; case (0x7|0x20): for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUINT_8_8_8_8_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putA8(c, &dest); } } } }; break; case 0x2: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUINT_8_8_8_8_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA4(c, &dest); } } } }; break; case 0x3: switch(glFormat) { case 0x1906: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUINT_8_8_8_8_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA8A(c, &dest); } } } }; break; default: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUINT_8_8_8_8_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA8(c, &dest); } } } }; break; } break; case 0x5: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUINT_8_8_8_8_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; put5A3(c, &dest); } } } }; break; case 0x4: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUINT_8_8_8_8_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; put565(c, &dest); } } } }; break; case 0x6: { for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUINT_8_8_8_8_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putAR(c, &dest); } } for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUINT_8_8_8_8_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putGB(c, &dest); } } } } } break; default: ((void)0); }; break;
    case 0x8036:
  switch(format) { case 0x1: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUINT_10_10_10_2(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putI8(c, &dest); } } } }; break; case (0x7|0x20): for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUINT_10_10_10_2(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putA8(c, &dest); } } } }; break; case 0x2: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUINT_10_10_10_2(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA4(c, &dest); } } } }; break; case 0x3: switch(glFormat) { case 0x1906: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUINT_10_10_10_2(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA8A(c, &dest); } } } }; break; default: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUINT_10_10_10_2(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA8(c, &dest); } } } }; break; } break; case 0x5: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUINT_10_10_10_2(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; put5A3(c, &dest); } } } }; break; case 0x4: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUINT_10_10_10_2(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; put565(c, &dest); } } } }; break; case 0x6: { for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUINT_10_10_10_2(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putAR(c, &dest); } } for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUINT_10_10_10_2(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putGB(c, &dest); } } } } } break; default: ((void)0); }; break;
 case 0x8368:
  switch(format) { case 0x1: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUINT_2_10_10_10_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putI8(c, &dest); } } } }; break; case (0x7|0x20): for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUINT_2_10_10_10_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putA8(c, &dest); } } } }; break; case 0x2: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUINT_2_10_10_10_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA4(c, &dest); } } } }; break; case 0x3: switch(glFormat) { case 0x1906: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUINT_2_10_10_10_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA8A(c, &dest); } } } }; break; default: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUINT_2_10_10_10_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA8(c, &dest); } } } }; break; } break; case 0x5: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUINT_2_10_10_10_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; put5A3(c, &dest); } } } }; break; case 0x4: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUINT_2_10_10_10_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; put565(c, &dest); } } } }; break; case 0x6: { for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUINT_2_10_10_10_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putAR(c, &dest); } } for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getUINT_2_10_10_10_REV(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putGB(c, &dest); } } } } } break; default: ((void)0); }; break;
 case 0x1401:
 case 0x1400:
 case 0x1402:
 case 0x1403:
 ...
 case 0x1406:
  ...
  switch(glFormat)
  {
  case 0x1903: switch(format) { case 0x1: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getRED(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putI8(c, &dest); } } } }; break; case (0x7|0x20): for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getRED(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putA8(c, &dest); } } } }; break; case 0x2: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getRED(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA4(c, &dest); } } } }; break; case 0x3: switch(glFormat) { case 0x1906: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getRED(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA8A(c, &dest); } } } }; break; default: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getRED(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA8(c, &dest); } } } }; break; } break; case 0x5: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getRED(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; put5A3(c, &dest); } } } }; break; case 0x4: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getRED(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; put565(c, &dest); } } } }; break; case 0x6: { for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getRED(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putAR(c, &dest); } } for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getRED(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putGB(c, &dest); } } } } } break; default: ((void)0); }; break;
  case 0x1904: switch(format) { case 0x1: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getGREEN(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putI8(c, &dest); } } } }; break; case (0x7|0x20): for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getGREEN(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putA8(c, &dest); } } } }; break; case 0x2: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getGREEN(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA4(c, &dest); } } } }; break; case 0x3: switch(glFormat) { case 0x1906: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getGREEN(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA8A(c, &dest); } } } }; break; default: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getGREEN(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA8(c, &dest); } } } }; break; } break; case 0x5: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getGREEN(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; put5A3(c, &dest); } } } }; break; case 0x4: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getGREEN(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; put565(c, &dest); } } } }; break; case 0x6: { for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getGREEN(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putAR(c, &dest); } } for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getGREEN(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putGB(c, &dest); } } } } } break; default: ((void)0); }; break;
  case 0x1905: switch(format) { case 0x1: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getBLUE(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putI8(c, &dest); } } } }; break; case (0x7|0x20): for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getBLUE(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putA8(c, &dest); } } } }; break; case 0x2: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getBLUE(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA4(c, &dest); } } } }; break; case 0x3: switch(glFormat) { case 0x1906: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getBLUE(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA8A(c, &dest); } } } }; break; default: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getBLUE(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA8(c, &dest); } } } }; break; } break; case 0x5: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getBLUE(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; put5A3(c, &dest); } } } }; break; case 0x4: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getBLUE(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; put565(c, &dest); } } } }; break; case 0x6: { for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getBLUE(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putAR(c, &dest); } } for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getBLUE(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putGB(c, &dest); } } } } } break; default: ((void)0); }; break;
  case 0x1906: switch(format) { case 0x1: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getALPHA(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putI8(c, &dest); } } } }; break; case (0x7|0x20): for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getALPHA(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putA8(c, &dest); } } } }; break; case 0x2: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getALPHA(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA4(c, &dest); } } } }; break; case 0x3: switch(glFormat) { case 0x1906: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getALPHA(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA8A(c, &dest); } } } }; break; default: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getALPHA(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA8(c, &dest); } } } }; break; } break; case 0x5: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getALPHA(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; put5A3(c, &dest); } } } }; break; case 0x4: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getALPHA(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; put565(c, &dest); } } } }; break; case 0x6: { for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getALPHA(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putAR(c, &dest); } } for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getALPHA(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putGB(c, &dest); } } } } } break; default: ((void)0); }; break;
  case 0x1909: switch(format) { case 0x1: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getLUMINANCE(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putI8(c, &dest); } } } }; break; case (0x7|0x20): for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getLUMINANCE(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putA8(c, &dest); } } } }; break; case 0x2: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getLUMINANCE(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA4(c, &dest); } } } }; break; case 0x3: switch(glFormat) { case 0x1906: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getLUMINANCE(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA8A(c, &dest); } } } }; break; default: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getLUMINANCE(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA8(c, &dest); } } } }; break; } break; case 0x5: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getLUMINANCE(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; put5A3(c, &dest); } } } }; break; case 0x4: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getLUMINANCE(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; put565(c, &dest); } } } }; break; case 0x6: { for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getLUMINANCE(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putAR(c, &dest); } } for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getLUMINANCE(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putGB(c, &dest); } } } } } break; default: ((void)0); }; break;
  case 0x190A: switch(format) { case 0x1: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getLUMINANCE_ALPHA(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putI8(c, &dest); } } } }; break; case (0x7|0x20): for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getLUMINANCE_ALPHA(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putA8(c, &dest); } } } }; break; case 0x2: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getLUMINANCE_ALPHA(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA4(c, &dest); } } } }; break; case 0x3: switch(glFormat) { case 0x1906: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getLUMINANCE_ALPHA(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA8A(c, &dest); } } } }; break; default: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getLUMINANCE_ALPHA(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA8(c, &dest); } } } }; break; } break; case 0x5: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getLUMINANCE_ALPHA(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; put5A3(c, &dest); } } } }; break; case 0x4: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getLUMINANCE_ALPHA(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; put565(c, &dest); } } } }; break; case 0x6: { for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getLUMINANCE_ALPHA(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putAR(c, &dest); } } for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getLUMINANCE_ALPHA(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putGB(c, &dest); } } } } } break; default: ((void)0); }; break;
  case 0x80E0:
  case 0x1907: switch(format) { case 0x1: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getRGB(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putI8(c, &dest); } } } }; break; case (0x7|0x20): for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getRGB(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putA8(c, &dest); } } } }; break; case 0x2: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getRGB(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA4(c, &dest); } } } }; break; case 0x3: switch(glFormat) { case 0x1906: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getRGB(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA8A(c, &dest); } } } }; break; default: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getRGB(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA8(c, &dest); } } } }; break; } break; case 0x5: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getRGB(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; put5A3(c, &dest); } } } }; break; case 0x4: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getRGB(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; put565(c, &dest); } } } }; break; case 0x6: { for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getRGB(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putAR(c, &dest); } } for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getRGB(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putGB(c, &dest); } } } } } break; default: ((void)0); }; break;
  case 0x80E1:
  case 0x1908: switch(format) { case 0x1: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getRGBA(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putI8(c, &dest); } } } }; break; case (0x7|0x20): for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getRGBA(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putA8(c, &dest); } } } }; break; case 0x2: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getRGBA(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA4(c, &dest); } } } }; break; case 0x3: switch(glFormat) { case 0x1906: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getRGBA(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA8A(c, &dest); } } } }; break; default: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getRGBA(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putIA8(c, &dest); } } } }; break; } break; case 0x5: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getRGBA(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; put5A3(c, &dest); } } } }; break; case 0x4: for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getRGBA(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; put565(c, &dest); } } } }; break; case 0x6: { for(j = 0; j < yblocks; ++j) { for(i = 0; i < xblocks; ++i) { for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y > max_y) { return; } if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getRGBA(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putAR(c, &dest); } } for(l = 0; l < yblock; ++l) { int y = yblock*j+l; if(y < yoffset) { OffsetN(&dest, dest_size*xblock); continue; } for(k = 0; k < xblock; ++k) { int x = xblock*i+k; if(x < xoffset || x > max_x) { OffsetN(&dest, dest_size); continue; } getRGBA(((void*)(p + col_size*(x) + row_size*(y))), c); if(swap_br){ t = c[0]; c[0] = c[2]; c[2] = t; }; putGB(c, &dest); } } } } } break; default: ((void)0); }; break;
  }
  break;
 }
}

_Bool requireTransform()
{
 size_t i;
 for(i = 0; i < 4; ++i)
 {
...
# 65 "D:\\devkitPro\\/libogc/include/ogc/lwp_watchdog.h"
...
# 1435 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/gl_transfer.c" 2
# 1 "D:\\devkitPro\\/libogc/include/ogc/video.h" 1
# 1436 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/gl_transfer.c" 2
...
void TransferPixels(GLenum glFormat, void *dest, u32 format, const GLvoid *pixels, GLenum type, size_t width, size_t height, size_t xoffset, size_t yoffset, size_t transwidth, size_t transheight)
{
 ...
 if(!requireTransform() && format != 0x0)
 {
