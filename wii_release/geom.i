# 1 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/libtess/geom.c"
# 1 "D:\\devkitPro\\portlibs\\thirdparty\\gl2gx\\libogc\\wii_release//"
# 1 "<command-line>"
# 1 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/libtess/geom.c"
# 42 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/libtess/geom.c"
# 1 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/include/gluos.h" 1
# 43 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/libtess/geom.c" 2
# 1 "d:\\devkitpro\\devkitppc\\powerpc-eabi\\include\\assert.h" 1 3
# 9 "d:\\devkitpro\\devkitppc\\powerpc-eabi\\include\\assert.h" 3
...
# 10 "d:\\devkitpro\\devkitppc\\powerpc-eabi\\include\\assert.h" 2 3
# 39 "d:\\devkitpro\\devkitppc\\powerpc-eabi\\include\\assert.h" 3
void __assert (const char *, int, const char *) __attribute__ ((__noreturn__))
                                 ;
void __assert_func (const char *, int, const char *, const char *) __attribute__ ((__noreturn__))
                                 ;
# 44 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/libtess/geom.c" 2
# 1 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/libtess/mesh.h" 1
# 45 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/libtess/mesh.h"
...
# 46 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/libtess/mesh.h" 2
...
# 121 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/libtess/mesh.h"
struct GLUvertex {
  GLUvertex *next;
  GLUvertex *prev;
  GLUhalfEdge *anEdge;
...
# 170 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/libtess/mesh.h"
struct GLUmesh {
  GLUvertex vHead;
  GLUface fHead;
  GLUhalfEdge eHead;
...
# 254 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/libtess/mesh.h"
...
# 45 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/libtess/geom.c" 2
# 1 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/libtess/geom.h" 1
# 80 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/libtess/geom.h"
...
void __gl_edgeIntersect( GLUvertex *o1, GLUvertex *d1,
        ...
        GLUvertex *v );
# 46 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/libtess/geom.c" 2
...
GLdouble __gl_edgeEval( GLUvertex *u, GLUvertex *v, GLUvertex *w )
{
# 66 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/libtess/geom.c"
  GLdouble gapL, gapR;
...
GLdouble __gl_transEval( GLUvertex *u, GLUvertex *v, GLUvertex *w )
{
# 121 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/libtess/geom.c"
  GLdouble gapL, gapR;
...
# 210 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/libtess/geom.c"
void __gl_edgeIntersect( GLUvertex *o1, GLUvertex *d1,
    GLUvertex *o2, GLUvertex *d2,
    GLUvertex *v )
...
{
  GLdouble z1, z2;
# 228 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/libtess/geom.c"
  if( ! (((o1)->s < (d1)->s) || ((o1)->s == (d1)->s && (o1)->t <= (d1)->t))) { if (1) { GLUvertex *t = o1; o1 = d1; d1 = t; } else; }
  if( ! (((o2)->s < (d2)->s) || ((o2)->s == (d2)->s && (o2)->t <= (d2)->t))) { if (1) { GLUvertex *t = o2; o2 = d2; d2 = t; } else; }
  if( ! (((o1)->s < (o2)->s) || ((o1)->s == (o2)->s && (o1)->t <= (o2)->t))) { if (1) { GLUvertex *t = o1; o1 = o2; o2 = t; } else; if (1) { GLUvertex *t = d1; d1 = d2; d2 = t; } else; }
  ...
  if( ! (((o2)->s < (d1)->s) || ((o2)->s == (d1)->s && (o2)->t <= (d1)->t))) {
    ...
    z1 = __gl_edgeEval(o1,o2,d1);
    z2 = __gl_edgeEval(o2,d1,d2);
    if( z1+z2 < 0 ) { z1 = -z1; z2 = -z2; }
    v->s = (z1 = (z1 < 0) ? 0 : z1, z2 = (z2 < 0) ? 0 : z2, ((z1 <= z2) ? ((z2 == 0) ? ((o2->s+d1->s) / 2) : (o2->s + (d1->s-o2->s) * (z1/(z1+z2)))) : (d1->s + (o2->s-d1->s) * (z2/(z1+z2)))));
  } else {

    z1 = __gl_edgeSign(o1,o2,d1);
    z2 = -__gl_edgeSign(o1,d2,d1);
    if( z1+z2 < 0 ) { z1 = -z1; z2 = -z2; }
    v->s = (z1 = (z1 < 0) ? 0 : z1, z2 = (z2 < 0) ? 0 : z2, ((z1 <= z2) ? ((z2 == 0) ? ((o2->s+d2->s) / 2) : (o2->s + (d2->s-o2->s) * (z1/(z1+z2)))) : (d2->s + (o2->s-d2->s) * (z2/(z1+z2)))));
  }



  if( ! (((o1)->t < (d1)->t) || ((o1)->t == (d1)->t && (o1)->s <= (d1)->s))) { if (1) { GLUvertex *t = o1; o1 = d1; d1 = t; } else; }
  if( ! (((o2)->t < (d2)->t) || ((o2)->t == (d2)->t && (o2)->s <= (d2)->s))) { if (1) { GLUvertex *t = o2; o2 = d2; d2 = t; } else; }
  if( ! (((o1)->t < (o2)->t) || ((o1)->t == (o2)->t && (o1)->s <= (o2)->s))) { if (1) { GLUvertex *t = o1; o1 = o2; o2 = t; } else; if (1) { GLUvertex *t = d1; d1 = d2; d2 = t; } else; }
  ...
  if( ! (((o2)->t < (d1)->t) || ((o2)->t == (d1)->t && (o2)->s <= (d1)->s))) {
    ...
    z1 = __gl_transEval(o1,o2,d1);
    z2 = __gl_transEval(o2,d1,d2);
    if( z1+z2 < 0 ) { z1 = -z1; z2 = -z2; }
    v->t = (z1 = (z1 < 0) ? 0 : z1, z2 = (z2 < 0) ? 0 : z2, ((z1 <= z2) ? ((z2 == 0) ? ((o2->t+d1->t) / 2) : (o2->t + (d1->t-o2->t) * (z1/(z1+z2)))) : (d1->t + (o2->t-d1->t) * (z2/(z1+z2)))));
  } else {

    z1 = __gl_transSign(o1,o2,d1);
    z2 = -__gl_transSign(o1,d2,d1);
    if( z1+z2 < 0 ) { z1 = -z1; z2 = -z2; }
    v->t = (z1 = (z1 < 0) ? 0 : z1, z2 = (z2 < 0) ? 0 : z2, ((z1 <= z2) ? ((z2 == 0) ? ((o2->t+d2->t) / 2) : (o2->t + (d2->t-o2->t) * (z1/(z1+z2)))) : (d2->t + (o2->t-d2->t) * (z2/(z1+z2)))));
  }
}
