# 1 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/gl_stacks.c"
...
# 2 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/gl_stacks.c" 2
...
# 3 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/gl_stacks.c" 2
...
# 4 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/gl_stacks.c" 2
...
# 5 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/gl_stacks.c" 2
...
# 7 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/gl_stacks.c" 2
...
{
 GXColorf accum_clear;
} accum_buffer;

static _Bool pushAccum(void ** p, void * end)
{
 accum_buffer ** ptr = (accum_buffer **) p;

 if((void*)((*ptr)+1) > end) { return 0; };
...
# 48 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/gl_stacks.c"
typedef struct color_buffer
{
 unsigned alpha_test:1;
 unsigned dither:1;
 unsigned color_logic_op:1;
 unsigned index_logic_op:1;
 unsigned red_mask:1;
 ...
 GXColorf blend_const_color;
 GLenum draw_buffer;

 GXColor clear_color;
} color_buffer;

static _Bool pushColorBuffer(void ** p, void * end)
{
 ...
 (*ptr)->red_mask = (color_write_mask[0] == 1) ? 1 : 0;
 (*ptr)->green_mask = (color_write_mask[1] == 1) ? 1 : 0;
 (*ptr)->blue_mask = (color_write_mask[2] == 1) ? 1 : 0;
 (*ptr)++->alpha_mask = (color_write_mask[3] == 1) ? 1 : 0;
...
static void popColorBuffer(void ** p)
{
 ...
 color_write_mask[0] = (*ptr)->red_mask == 1 ? 1 : 0;
 color_write_mask[1] = (*ptr)->green_mask == 1 ? 1 : 0;
 color_write_mask[2] = (*ptr)->blue_mask == 1 ? 1 : 0;
 color_write_mask[3] = (*ptr)->alpha_mask == 1 ? 1 : 0;
}
# 125 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/gl_stacks.c"
typedef struct current
{
 unsigned raster_valid:1;
 unsigned edge_flag:1;

 float index;
 GXColorf color;
 Vector normal;
 TexCoordElement tex_coords[8];

 VertexElement raster_pos;
 float raster_index;
 GXColorf raster_color;
 TexCoordElement raster_tex_coords[8];
} current;

static _Bool pushCurrent(void ** p, void * end)
{
...
static _Bool pushDepthBuffer(void ** p, void * end)
{
 depth_buffer ** ptr = (depth_buffer **) p;

 if((void*)((*ptr)+1) > end) { return 0; };

 (*ptr)->depth_test = (depthtestenabled == 1) ? 1 : 0;
 (*ptr)->depth_write = (depthupdate == 1) ? 1 : 0;
...
static void popDepthBuffer(void ** p)
{
 ...
 depthtestenabled = (*ptr)->depth_test == 1 ? 1 : 0;
 depthupdate = (*ptr)->depth_write == 1 ? 1 : 0;
 depthfunction = (*ptr)->depth_func;
 _cleardepth = (*ptr)->depth_clear;
}
# 245 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/gl_stacks.c"
typedef struct enable
{
 unsigned alpha_test:1;
 unsigned auto_normal:1;
 unsigned blend:1;
 ...
 unsigned polygon_offset_line:1;
 unsigned polygon_offset_fill:1;
 unsigned polygon_offset_point:1;
 unsigned polygon_smooth:1;
 unsigned polygon_stipple:1;
 unsigned scissor_test:1;
 unsigned stencil_test:1;
 unsigned texture_1d:1;
 unsigned texture_2d:1;
} enable;

static _Bool pushEnable(void ** p, void * end)
{
 enable ** ptr = (enable **) p;

 if((void*)((*ptr)+1) > end) { return 0; };

 (*ptr)->blend = blend_type == 1 ? 1 : 0;
 (*ptr)->color_material = copy_mat_enabled == 1 ? 1 : 0;
 (*ptr)->cull_face = gxcullfaceanabled == 1 ? 1 : 0;
 (*ptr)->depth_test = depthtestenabled == 1 ? 1 : 0;
 (*ptr)->fog = fog_enable == 1 ? 1 : 0;
 ...
 (*ptr)->lighting = lighting == 1 ? 1 : 0;
 (*ptr)->scissor_test = (scissor_test == 0x1) ? 1 : 0;
...
static void popEnable(void ** p)
{
 ...
 blend_type = (*ptr)->blend == 1 ? 1 : 0;
 copy_mat_enabled = (*ptr)->color_material == 1 ? 1 : 0;
 gxcullfaceanabled = (*ptr)->cull_face == 1 ? 1 : 0;
 depthtestenabled = (*ptr)->depth_test == 1 ? 0x1 : 0;
 fog_enable = (*ptr)->fog == 1 ? 1 : 0;
 ...
 lighting = (*ptr)->lighting == 1 ? 1 : 0;
 scissor_test = (*ptr)->scissor_test == 1 ? 0x1 : 0x0;

 _Bool tex2d = (*ptr)->texture_2d ? 1 : 0;
...
static _Bool pushEval(void ** p, void * end)
{
 eval ** ptr = (eval **) p;
...
# 370 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/gl_stacks.c"
typedef struct fog
{
...
static _Bool pushFog(void ** p, void * end)
{
 fog ** ptr = (fog **) p;

 if((void*)((*ptr)+1) > end) { return 0; };

 (*ptr)->fog_enable = (fog_enable == 1) ? 1 : 0;
...
static void popFog(void ** p)
{
 ...
 fog_enable = (*ptr)->fog_enable == 1 ? 1 : 0;
...
static _Bool pushHint(void ** p, void * end)
{
 hint ** ptr = (hint **) p;
...
# 461 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/gl_stacks.c"
...
static _Bool pushLighting(void ** p, void * end)
{
...
static _Bool pushLine(void ** p, void * end)
{
 line ** ptr = (line **) p;
...
static _Bool pushListBase(void ** p, void * end)
{
...
# 585 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/gl_stacks.c"
typedef struct pixel_mode
{
 unsigned map_color:1;
 unsigned map_stencil:1;
...
static _Bool pushPixelMode(void ** p, void * end)
{
...
static _Bool pushPoint(void ** p, void * end)
{
 point ** ptr = (point **) p;
...
# 674 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/gl_stacks.c"
typedef struct polygon
{
 ...
 GLenum cull_mode;
 GLenum front_poly_mode;
 GLenum back_poly_mode;
 GLfloat factor;
 GLfloat units;
} polygon;

static _Bool pushPolygon(void ** p, void * end)
{
 ...
 {
 case 1:
  (*ptr)->cull_mode = 0x0404;
  break;
 case 2:
  (*ptr)->cull_mode = 0x0405;
  break;
 case 3:
  (*ptr)->cull_mode = 0x0408;
  break;
 default:
  ((void)0);
 }
 (*ptr)->cull_ccw = (gxwinding == 0x0901) ? 1 : 0;
 (*ptr)++->cull_face = (gxcullfaceanabled == 1) ? 1 : 0;
...
static void popPolygon(void ** p)
{
 ...
 gxwinding = (*ptr)->cull_ccw == 1 ? 0x0901 : 0x0900;
 gxcullfaceanabled = (*ptr)->cull_face == 1 ? 1 : 0;
}
...
static _Bool pushPolyStipple(void ** p, void * end)
{
...
static _Bool pushScissor(void ** p, void * end)
{
...
static _Bool pushStencil(void ** p, void * end)
{
...
# 827 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/gl_stacks.c"
typedef struct texture
{
 TexCoordElement tex_coords[8];
 glTexEnvSet glTexEnv[8];
} texture;

static _Bool pushTexture(void ** p, void * end)
{
...
static _Bool pushTransform(void ** p, void * end)
{
...
static _Bool pushViewport(void ** p, void * end)
{
...
typedef _Bool (*pushFun)(void **, void *);
...
AttribOpt attribs[] = {
 {0x00000200, pushAccum, popAccum},
 {0x00004000, pushColorBuffer, popColorBuffer},
 {0x00000001, pushCurrent, popCurrent},
 {0x00000100, pushDepthBuffer, popDepthBuffer},
 {0x00002000, pushEnable, popEnable},
 {0x00010000, pushEval, popEval},
 {0x00000080, pushFog, popFog},
 {0x00008000, pushHint, popHint},
 {0x00000040, pushLighting, popLighting},
 {0x00000004, pushLine, popLine},
 {0x00020000, pushListBase, popListBase},
 {0x00000020, pushPixelMode, popPixelMode},
 {0x00000002, pushPoint, popPoint},
 {0x00000008, pushPolygon, popPolygon},
 {0x00000010, pushPolyStipple, popPolyStipple},
 {0x00080000, pushScissor, popScissor},
 {0x00000400, pushStencil, popStencil},
 {0x00040000, pushTexture, popTexture},
 {0x00001000, pushTransform, popTransform},
 {0x00000800, pushViewport, popViewport}
};
...
static attribStack_t attribStack = {{0},0,((void *)0),((void *)0), 0};
static attribStack_t clientAttribStack = {{0},0,((void *)0),((void *)0), 0};;
...
static _Bool resizeStack(attribStack_t * ptr)
{
 void * begin = ((void *)0);
 size_t new_size = 0;
 if(ptr->size == 0)
...
{
 *ptr = (attribStack_t){{0},0,((void *)0),((void *)0), 0};
 resizeStack(ptr);
...
static void push(attribStack_t * ptr, AttribOpt * opts, size_t n_opts, GLenum mask)
{
 ...
 if(ptr->typeCur >= 16)
 {
  _glSetErrorEx(0x0503, "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/gl_stacks.c", 1043);
  return;
 }
  ...
  if((opts[i].mask & mask) == opts[i].mask)
  {
   while(!opts[i].push(&cur, stackEnd(ptr)))
   {
    ...
    if(!resizeStack(ptr))
    {
     ...
     _glSetErrorEx(0x0503, "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/gl_stacks.c", 1062);
     return;
    }
   }
  }
...
static void pop(attribStack_t * ptr, AttribOpt * opts, size_t n_opts)
{
 ...
 if(ptr->typeCur == 0)
 {
  _glSetErrorEx(0x0504, "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/gl_stacks.c", 1082);
  return;
 }
...
{
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/gl_stacks.c", 1107); return; };
...
{
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/gl_stacks.c", 1114); return; };
...
static _Bool pushPixelStore(void ** p, void * end)
{
...
static _Bool pushVertexArray(void ** p, void * end)
{
...
AttribOpt clientAttribs[] = {
 {0x00000001, pushPixelStore, popPixelStore},
 {0x00000002, pushVertexArray, popVertexArray}
};

void glPushClientAttrib( GLbitfield mask )
{
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/gl_stacks.c", 1202); return; };
...
{
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/gl_stacks.c", 1209); return; };
