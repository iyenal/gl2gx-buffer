# 1 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/glut.c"
...
# 2 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/glut.c" 2
...
# 3 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/glut.c" 2
...
# 4 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/glut.c" 2
...
# 5 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/glut.c" 2
...
# 6 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/glut.c" 2
...
# 8 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/glut.c" 2
...
# 11 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/glut.c" 2
...
# 13 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/glut.c" 2

# 1 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/include/GL/glut.h" 1
# 138 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/include/GL/glut.h"
# 1 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/include/GL/glu.h" 1
# 269 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/include/GL/glu.h"
...
# 139 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/include/GL/glut.h" 2
# 159 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/include/GL/glut.h"
extern void exit(int);
# 320 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/include/GL/glut.h"
...
# 483 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/include/GL/glut.h"
...
# 672 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/include/GL/glut.h"
...
# 686 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/include/GL/glut.h"
...
# 15 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/glut.c" 2




char *__glutProgramName = ((void *)0);
static void *frameBuffer[2] = { ((void *)0), ((void *)0)};
GXRModeObj *rmode;
syswd_t watchdog;
...
void glutInit(int *argcp, char **argv) {
# 75 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/glut.c"
 ...
 int i = 0;
 for (i=0;i<8;i++){
  lights[i].pos.v = (Vector){0.0f,0.0f,1.0f};
  lights[i].pos.w = 0;
        ...
        lights[i].spotDir = (Vector) {0.0, 0.0, -1.0};
 ...
 norm.stride = sizeof(Vector);
 norm.type = 0x1406;
 norm.size = 3;

 vert.enable = 0;
 vert.p = _vertexelements;
 vert.stride = sizeof(Vector);
 vert.size = 3;
 vert.type = 0x1406;
...
_Bool _console_enabled = 0;
_Bool _console_inited = 0;
...
void glutInitDisplayMode(unsigned int mode) {
 ...
 frameBuffer[0] = (void*)((u32)(SYS_AllocateFramebuffer(rmode)) + ((0xC0000000) - (0x80000000)));
 frameBuffer[1] = (void*)((u32)(SYS_AllocateFramebuffer(rmode)) + ((0xC0000000) - (0x80000000)));
 ...
 VIDEO_Flush();
 VIDEO_WaitVSync();
 if(rmode->viTVMode&1) VIDEO_WaitVSync();
 ...
 GXColor c = (GXColor){0x7F,0x7F,0x7F,0xFF};

 GX_SetCopyClear(c, 0);
 GX_CopyDisp(frameBuffer[fb],1);
 GX_SetCopyClear(c, 0x00ffffff);
 GX_CopyDisp(frameBuffer[fb],1);
 GX_CopyDisp(frameBuffer[fb],1);
 GX_SetDispCopyGamma(0);
# 332 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/glut.c"
 GX_SetVtxAttrFmt(0, 9, 1, 4, 0);
 GX_SetVtxAttrFmt(0, 10, 0, 4, 0);
 ...
 for(i = 0; i < 8; ++i)
 {
  GX_SetVtxAttrFmt(0, incTexDesc(i), 1, 4, 0);
 }

 GX_SetArray (9, ((void *)0), 0);
 GX_SetArray (10, ((void *)0), 0);
 GX_SetArray (11, ((void *)0), 0);
 for(i = 0; i < 8; ++i)
 {
  GX_SetArray (incTexDesc(i), ((void *)0), 0);
 }
...
int glutGet(GLenum type) {
 ...
 switch(type)
 {
 case ((GLenum) 200): retval = 640; break;
 case ((GLenum) 201): retval = 480; break;
 case ((GLenum) 504): retval = 0 | 2 | 16; break;
 }
 return retval;
}

void (*displayfunc)(void) = ((void *)0);

void glutDisplayFunc(void (*func)(void)){
 displayfunc = func;
}

void (*idlefunc)(void) = ((void *)0);
...
void glutMainLoop(void){
 ...
 if(watchdog_conf)
 {
  ...
  SYS_SetPeriodicAlarm(watchdog, &start, &interval, &timercallback, ((void *)0));
 }

 lwp_t draw_thread;

 LWP_CreateThread(&draw_thread, &glutThread, 0, ((void *)0), 0, 67);
