# 1 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/gl_outcopy.c"
...
# 10 "d:\\devkitpro\\devkitppc\\powerpc-eabi\\include\\stdlib.h" 3
# 1 "d:\\devkitpro\\devkitppc\\powerpc-eabi\\include\\machine\\ieeefp.h" 1 3
# 11 "d:\\devkitpro\\devkitppc\\powerpc-eabi\\include\\stdlib.h" 2 3
...
# 12 "d:\\devkitpro\\devkitppc\\powerpc-eabi\\include\\stdlib.h" 2 3
...
# 19 "d:\\devkitpro\\devkitppc\\powerpc-eabi\\include\\stdlib.h" 2 3
...
# 9 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/include/GL/GLwii.h" 2
...
# 2 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/gl_outcopy.c" 2
...
# 27 "d:\\devkitpro\\devkitppc\\powerpc-eabi\\include\\time.h" 3
...
# 28 "d:\\devkitpro\\devkitppc\\powerpc-eabi\\include\\time.h" 2 3
...
# 3 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/gl_outcopy.c" 2
# 1 "d:\\devkitpro\\devkitppc\\powerpc-eabi\\include\\stdio.h" 1 3
# 35 "d:\\devkitpro\\devkitppc\\powerpc-eabi\\include\\stdio.h" 3
# 1 "d:\\devkitpro\\devkitppc\\lib\\gcc\\powerpc-eabi\\4.8.2\\include\\stddef.h" 1 3 4
...
# 49 "d:\\devkitpro\\devkitppc\\powerpc-eabi\\include\\stdio.h" 3
...
# 341 "d:\\devkitpro\\devkitppc\\powerpc-eabi\\include\\stdio.h" 3
...
# 4 "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/gl_outcopy.c" 2

void glReadBuffer( GLenum mode )
{
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/gl_outcopy.c", 7); return; };
 ...
 case 0x0402:
  ...
  break;
 default:
  _glSetErrorEx(0x0502, "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/gl_outcopy.c", 21);
  return;
 }
};
...
static __inline__ void put_UINT_10_10_10_2(void *pixel, u8 *rgba)
{
 ...
 r = rgba[0]*4.0117647058823529411;
 if(r > 1023)
 {
  r = 1023;
 }
 g = rgba[1]*4.0117647058823529411;
 if(g > 1023)
 {
  g = 1023;
 }
 b = rgba[2]*4.0117647058823529411;
 if(b > 1023)
 {
  b = 1023;
 }

 *p = r << 22 | g << 12 | b << 2 | (rgba[3] & 0xC0) >> 6;
}
...
{
 fun(&pixel, GetIlum(rgba[0],rgba[1],rgba[2]));
}
...
{
 rgba[0] = clamp_255(( 298.082 * Y + 408.583 * Cr ) / 256 - 222.921);
 rgba[1] = clamp_255(( 298.082 * Y - 100.291 * Cb - 208.120 * Cr ) / 256 + 135.576);
 rgba[2] = clamp_255(( 298.082 * Y + 516.412 * Cb ) / 256 - 276.836);
}
...
void glReadPixels( GLint x, GLint y,
                                    ...
                                    GLvoid *pixels )
{
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/gl_outcopy.c", 390); return; };

 if(width < 0 || height < 0)
 {
  _glSetErrorEx(0x0501, "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/gl_outcopy.c", 394);
  return;
 }
 ...
 switch(format)
 {
  ...
  case 0x1902:
  default:
   _glSetErrorEx(0x0500, "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/gl_outcopy.c", 416);
   return;
   break;
 }
 ...
 switch(type)
 {
  ...
  case 0x1A00:
  default:
   _glSetErrorEx(0x0500, "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/gl_outcopy.c", 446);
   return;
   break;
 }
...
void glGetTexImage( GLenum target, GLint level,
                                     ...
                                     GLvoid *pixels )
{
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "D:/devkitPro/portlibs/thirdparty/gl2gx/libogc/../source/gl_outcopy.c", 524); return; };
};
